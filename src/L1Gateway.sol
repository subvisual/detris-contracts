 ...
 */
contract L1Gateway is IERC721Gateway, CrossDomainEnabled, IERC721Receiver {
    /********************************
     ...
     */
    function _handleFinalizeWithdrawal(address _to, uint256 _tokenId) internal {
    ...
    function _sendDepositMessage(
        ...
        bytes memory data = abi.encodeWithSelector(
            IL2DepositedERC721.finalizeDeposit.selector,
            _to,
            _tokenId,
        ...
        sendCrossDomainMessage(depositedToken, getFinalizeDepositGas(), data);
    ...
    function _initiateDeposit(
        ...
        _sendDepositMessage(_from, _to, _tokenId);
    }
